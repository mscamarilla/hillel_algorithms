...
count(arr, 1, 4); // 2   (подходят элементы 1, 4) первый, совпадает
...
count(arr, 1000, 2000); // 5   (подходят элементы 1099, 1200, 1201, 1202, 2000) последний, совпадает
count(arr, 84, 84); // 1   (подходит элемент 84)
count(arr, 1202, 2000); // 2   (подходят элементы 1202, 2000) последний, совпадает
